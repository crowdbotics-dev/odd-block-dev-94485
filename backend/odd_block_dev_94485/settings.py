"""
Django settings for odd_block_dev_94485 project.
...
ROOT_URLCONF = 'odd_block_dev_94485.urls'
...
WSGI_APPLICATION = 'odd_block_dev_94485.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_block_dev_94485 API",
    "DESCRIPTION": "API documentation for odd_block_dev_94485 App",
    "VERSION": "v1",
}
